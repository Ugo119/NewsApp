...
/*
 * Helper methods related to requesting and receiving football data from Guardian.
 */
public final class QueryUtils {
    ...
    private static List<Football> extractFeatureFromJson(String footballJSON) {
        ...
        try {
            ...
            // build up a list of Football News objects with the corresponding data.
            ...
            // For each football news in the footballArray, create an {@link Earthquake} object
            for (int i = 0; i < footballArray.length(); i++) {

                // Get a single football news item at position i within the list of football news
                ...
                Football footballItems = new Football(description, time, type, url);
                footballNews.add(footballItems);
            }
            ...
            Log.e("QueryUtils", "Problem parsing the football news JSON results", e);
        }
    ...
    /*
     * Query the Guardian dataset and return a list of {@link Football} objects.
     */
    public static List<Football> fetchFootballData(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create a list of {@link Football news}
        List<Football> footballNewsItems = extractFeatureFromJson(jsonResponse);
